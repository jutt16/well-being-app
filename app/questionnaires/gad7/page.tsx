...
const followUpQuestion = {
  id: "followup",
  text: "If you checked any problems, how difficult have these made it for you to do your work, take care of things at home, or get along with other people?",
  options: [
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your GAD-7 assessment has been saved successfully.",
      })

      // Redirect to results page
      router.push(
        `/questionnaires/results?type=gad7&score=${score}&interpretation=${encodeURIComponent(interpretation)}`,
      )
    } catch (error) {
      toast({
    ...
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold flex items-center gap-2 mb-2">
          <Brain className="h-6 w-6" /> GAD-7 Assessment
        </h1>
